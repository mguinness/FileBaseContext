...
public partial class FileBaseContextShapedQueryCompilingExpressionVisitor
{
    private sealed class ShaperExpressionProcessingExpressionVisitor : ExpressionVisitor
    {
        ...
        private readonly FileBaseContextShapedQueryCompilingExpressionVisitor _FileBaseContextShapedQueryCompilingExpressionVisitor;
        ...
        public ShaperExpressionProcessingExpressionVisitor(
            FileBaseContextShapedQueryCompilingExpressionVisitor FileBaseContextShapedQueryCompilingExpressionVisitor,
            FileBaseContextQueryExpression FileBaseContextQueryExpression,
            bool tracking)
        {
            _FileBaseContextShapedQueryCompilingExpressionVisitor = FileBaseContextShapedQueryCompilingExpressionVisitor;
            _valueBufferParameter = FileBaseContextQueryExpression.CurrentParameter;
            _tracking = tracking;
        }
            ...
            switch (extensionExpression)
            {
                ...
                case ProjectionBindingExpression projectionBindingExpression:
                {
                    ...
                    if (!_mapping.TryGetValue(key, out var variable))
                    {
                        ...
                        _variables.Add(variable);
                        var queryExpression = (FileBaseContextQueryExpression)projectionBindingExpression.QueryExpression;
                ...
                case IncludeExpression includeExpression:
                {
                    ...
                    if (includeExpression.Navigation.IsCollection)
                    {
                        ...
                        var shaperLambda = new ShaperExpressionProcessingExpressionVisitor(
                                _FileBaseContextShapedQueryCompilingExpressionVisitor, _tracking)
